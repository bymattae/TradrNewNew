  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-gradient-radial from-[#320D66] via-[#1C1C24] to-[#15161B] overflow-hidden">
      <div className="w-full max-w-md mx-auto h-full flex flex-col">
        ...
        {/* Main Content Area */}
        <div className="flex-1 flex flex-col px-4 pb-0 mt-2 overflow-hidden">
          {/* Profile Preview Card */}
          <div className="flex-1 flex flex-col overflow-hidden mb-[4.5rem]">
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2 }}
              className="w-full h-full rounded-3xl bg-[#1C1C24]/80 backdrop-blur-xl border border-white/5 shadow-[0_0_25px_rgba(168,85,247,0.1)] flex flex-col overflow-hidden"
            >
              {/* Scrollable Content */}
