...
export default function DashboardPage() {
  ...
  return (
    <div className="h-full overflow-hidden flex flex-col">
      <div className="flex-1 h-full overflow-hidden px-4 py-3">
        <div className="h-full mx-auto flex flex-col max-w-lg">
          {/* Top Navigation */}
          <div className="flex items-center justify-between mb-3">
            <h1 className="text-xl font-bold text-white">My Tradr</h1>
            <button 
          ...
          {/* Profile Preview - Fill remaining height */}
