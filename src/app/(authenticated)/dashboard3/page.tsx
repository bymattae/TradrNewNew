      ...
      <div className="w-full max-w-md mx-auto flex flex-col h-full">
        ...
        <div className="flex-1 flex flex-col px-4 pt-5 pb-20 overflow-hidden">
          ...
          <motion.div 
            ...
            className="w-full h-full rounded-3xl bg-[#1C1C24]/80 backdrop-blur-xl border border-white/5 shadow-[0_0_25px_rgba(168,85,247,0.1)] flex flex-col overflow-hidden z-20"
          >
            {/* Scrollable Content */}
