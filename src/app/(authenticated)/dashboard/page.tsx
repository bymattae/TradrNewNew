  ...
  return (
    <div className="h-screen w-full max-w-md mx-auto flex flex-col bg-black overflow-hidden">
      ...
      <div className="flex-1 flex flex-col px-6 py-3 space-y-3">
        {/* Link Card */}
        <div className="w-full bg-[#111] rounded-2xl p-3">
        ...
        {/* Profile Card */}
        <div className="w-full bg-[#111] rounded-2xl p-3 space-y-3">
      ...
      <div className="p-3">
        <button 
          className="w-12 h-12 bg-[#7C3AED] rounded-full flex items-center justify-center shadow-lg shadow-[#7C3AED]/20 hover:bg-[#6D28D9] transition-colors"
